...
export interface CreatorsCoinInterface extends utils.Interface {
  functions: {
    ...
    "setRepPerCRP(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setRepPerCRP",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(functionFragment: "swap()", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "swap(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "swap(address,uint256)",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  ...
  events: {
    ...
    "NewRepPerCRPSet(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewRepPerCRPSet"): EventFragment;
...
export interface NewRepPerCRPSetEventObject {
  manager: string;
  repPerCRP: BigNumber;
}
export type NewRepPerCRPSetEvent = TypedEvent<
  [string, BigNumber],
  NewRepPerCRPSetEventObject
>;

export type NewRepPerCRPSetEventFilter = TypedEventFilter<NewRepPerCRPSetEvent>;
...
export interface SwapEventObject {
  account: string;
  repTokenAmount: BigNumber;
  CRPTokenAmount: BigNumber;
}
...
export interface CreatorsCoin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreatorsCoinInterface;
  ...
  functions: {
    ...
    getRepPerCRP(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "NewRepPerCRPSet(address,uint256)"(
      manager?: PromiseOrValue<string> | null,
      repPerCRP?: null
    ): NewRepPerCRPSetEventFilter;
    NewRepPerCRPSet(
      manager?: PromiseOrValue<string> | null,
      repPerCRP?: null
    ): NewRepPerCRPSetEventFilter;
  ...
  populateTransaction: {
    ...
    getRepPerCRP(overrides?: CallOverrides): Promise<PopulatedTransaction>;
