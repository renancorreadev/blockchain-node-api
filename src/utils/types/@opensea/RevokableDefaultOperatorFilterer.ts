...
export interface RevokableDefaultOperatorFiltererInterface
...
export interface RevokableDefaultOperatorFilterer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RevokableDefaultOperatorFiltererInterface;
